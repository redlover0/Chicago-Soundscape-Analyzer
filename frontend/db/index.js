// export * from './noiseDataQueries.js';
// export * from './poolQuery.js';

// First, we're importing a helpful tool called 'pg' (think of it as a Swiss Army knife for working with PostgresSQL databases)
import pg from "pg";
...
// Note: Pool automatically finds our environment variables in .env to establish the connection
const pool = new Pool();
